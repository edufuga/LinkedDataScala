...
//type Ch[+_[_], +_] // ABSTRACT TYPE MEMBER
//type Eff[+_]       // ABSTRACT TYPE MEMBER 
//type St[+_] = EffectfulStream[Ch, Eff, _] // ABSTRACT TYPE MEMBERS (PARAMETERS)
//type StrDAO[I, C[+_[_], +_], +F[+_], +O] = DAO[I, O, St] // ABSTRACT TYPE MEMBERS (PARAMETERS)
// type ChannelingEffectfulDAO[I, C[+_[_], +_], +F[+_], +O]= DAO[I, O, EffectfulStream[C, F, _]] // Compile error (!!!)
